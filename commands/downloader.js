 ...
 * @author : NADEEN POORNA <https://github.com/SamPandey001>
 * @description : NADEEN'S,A Multi-functional whatsapp bot.
 * @version 0.0.6
 **/
...
cmd({
            pattern: "video",
            alias : ['1.3'],
            desc: "Downloads video from yt[@NADEEN].",
            react: "🎬",
            category: "downloader",
            filename: __filename,
        ...
        async(Void, citel, text) => {
            let yts = require("NADEEN POORNA BOT");
            let search = await yts(text);
            ...
            const getRandom = (ext) => {
                ...
                if (infoYt.videoDetails.lengthSeconds >= videotime) return citel.reply(`❌ Video එක ලොකු වැඩියි.100MB වලට වඩා අඩු ඒවා විතරි පුළුවන්!`);
